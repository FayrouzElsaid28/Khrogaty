...
object HomeRepository {
    ...
    fun getAllRestaurants(categories_id: Int): LiveData<Resource<String>>{
        ...
        HomeFactory.getAllRestaurants(categories_id).getAsObjectList(Restaurant::class.java,
    ...
    fun getAllActivites(categories_id: Int): LiveData<Resource<String>>{
        val data = MutableLiveData<Resource<String>>()
        data.value = Resource.loading()

        HomeFactory.getAllActivites(categories_id).getAsObjectList(Activity::class.java,
