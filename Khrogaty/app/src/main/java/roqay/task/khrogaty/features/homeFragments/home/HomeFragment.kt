...
import roqay.task.khrogaty.features.HomeViewModel
import roqay.task.khrogaty.features.homeFragments.home.Adapters.PlaceAdapter
import roqay.task.khrogaty.features.homeFragments.home.Adapters.RestaurantAdapter
import roqay.task.khrogaty.features.homeFragments.home.Adapters.ToDoAdapter

class HomeFragment : Fragment(), AdapterToViewCallBack {

    val placesAdapter = PlaceAdapter(this)
    val restaurantsAadapter = RestaurantAdapter(this)
